...
df = pd.read_csv("C:\Swinburne\Internship\Live Project\simulacrum_v2.1.0\simulacrum_v2.1.0\Data\sim_rtds_episode.csv")
...
table = Table('sim_rtds_episode', metadata, *columns)
metadata.create_all(engine)  # This will create the table if it does not exist

# Insert data into the table
df.to_sql('sim_rtds_episode', con=engine, if_exists='append', index=False, chunksize=5000)
